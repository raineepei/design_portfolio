    ...
    return (
        <div>
            ...
            <div>
                ...
                <p className={styles.sectiontext}>During Summer 2022, I worked as a research assistant in the Healthcare Robotics Lab under 
                an <span className={styles.boldblue}>REU</span> (Research Experience for Undergraduates).</p>
                ...
                <p className={styles.sectiontext}>The paper we worked on for <span className={styles.boldblueunder}><a href="https://humanrobotinteraction.org/2023/">HRI 2023</a></span> is now published! 
                Feel free to check it out <span className={styles.boldblueunder}><a href="https://dl.acm.org/doi/10.1145/3568162.3576993">here</a></span>. It explores how robots can support people with Mild
                Cognitive Impairment (PwMCI) in identifying and achieving their personal goals throughout a longitudinal health interventional (i.e. cognitively assistive robots). Super exciting!</p>
            </div>
